...
// ============================================
function SocialLinkItem({ platform, handle, href }: { platform: string; handle: string; href: string }) {
  return (
    <a
      href={href}
      target="_blank"
...
function TopicDropdown({
  ...
  const allOptions = [{ value: "", label: "Select a topic" }, ...options];
      ...
      <div className="min-h-screen bg-white">
        ...
        <section style={{ padding: 'clamp(2rem, 6vw, 4rem) clamp(1rem, 4vw, 5.75rem)' }}>
          <div className="max-w-xl">
            <div className="mb-6">
              <svg className="w-16 h-16 text-bvp-green" viewBox="0 0 64 64" fill="none" aria-hidden="true">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              {content.successMessage} For urgent matters, please email us directly at{" "}
              <a
          ...
          >
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div>
                  <label htmlFor="contact-firstName" className="block text-xs font-bold uppercase tracking-widest text-gray-400 mb-2">
                    First Name
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="contact-lastName" className="block text-xs font-bold uppercase tracking-widest text-gray-400 mb-2">
                    Last Name
                  </label>
                  <input
                    type="text"
              ...
              {/* Email */}
              <div>
                <label htmlFor="contact-email" className="block text-xs font-bold uppercase tracking-widest text-gray-400 mb-2">
                  Email *
                </label>
                <input
                  type="email"
              ...
              <TopicDropdown
                ...
                options={content.topicOptions}
              />

              {/* Message */}
              <div>
                <label htmlFor="contact-message" className="block text-xs font-bold uppercase tracking-widest text-gray-400 mb-2">
                  Message
                </label>
                <textarea
                  id="contact-message"
