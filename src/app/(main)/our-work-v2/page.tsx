...
import { OurWorkV2PageClient } from './OurWorkV2PageClient';
...
export default async function OurWorkV2Page() {
  ...
  return <OurWorkV2PageClient content={content} />;
}
