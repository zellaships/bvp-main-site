...
export interface JoinPageContent {
  ...
  veteranCard: CardContent;
  advocateCard: CardContent;
...
export function JoinPageClient({ content }: { content: JoinPageContent }) {
  ...
  // Member type options
  const memberTypeOptions = content.memberTypeOptions;
      ...
      <AnimatePresence mode="wait">
        {currentView === "main" && (
          ...
          >
            ...
            >
              <img
                src={content.heroImage || "/images/join-banner.jpg"}
            ...
            <section style={{ padding: 'clamp(2rem, 5vw, 3rem) clamp(1rem, 4vw, 5.75rem)' }}>
              <div className="max-w-xl">
                ...
                <p className="text-[17px] text-gray-700 leading-relaxed mb-8">
                  {content.advocateSuccessMessage}
                </p>
                <a
                  href="/"
