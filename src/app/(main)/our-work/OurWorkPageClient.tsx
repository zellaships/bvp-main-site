...
export function OurWorkPageClient({ content }: { content: OurWorkContent }) {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <p className="text-sm uppercase tracking-widest mb-4 text-white/80">{content.heroSubtitle}</p>
          <h1
      ...
      <section style={{ padding: 'clamp(2.5rem, 5vw, 4rem) clamp(1rem, 4vw, 5.75rem) clamp(3rem, 8vw, 5rem)' }}>
        <div className="max-w-[900px] mx-auto">
          ...
          <div id="litigation" className="scroll-mt-40" style={{ marginBottom: 'clamp(4rem, 10vw, 8rem)' }}>
            ...
            <div style={{ marginBottom: 'clamp(2rem, 4vw, 3rem)' }}>
              <div className="relative w-full rounded-2xl overflow-hidden shadow-lg" style={{ paddingBottom: '56.25%' }}>
                <iframe
                  className="absolute inset-0 w-full h-full"
                  src={content.litigationVideoUrl}
            ...
            <CTABox
              title={content.litigationCTA.title}
              buttonText={content.litigationCTA.buttonText}
              href={content.litigationCTA.href}
          ...
          <div id="narrative" className="scroll-mt-40" style={{ marginBottom: 'clamp(4rem, 10vw, 8rem)' }}>
            ...
            <CTABox
              title={content.narrativeCTA.title}
              buttonText={content.narrativeCTA.buttonText}
              href={content.narrativeCTA.href}
              external={content.narrativeCTA.isExternal}
          ...
          <div id="mobilization" className="scroll-mt-40">
            ...
            <CTABox
              title={content.mobilizationCTA.title}
              buttonText={content.mobilizationCTA.buttonText}
              href={content.mobilizationCTA.href}
